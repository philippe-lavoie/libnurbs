...
namespace PLib {
  ...
  template <>
    int ParaSurface<double,2>::intersectWith(const ParaSurface<double,2> &S, Point_nD<double,2>& p, double& u, double& v, double& s, double& t, int maxI, double um, double uM, double vm, double vM) const{ cerr << "NOT DEFINED FOR 2D SURFACES.\n";}
  
  template <>
    int ParaSurface<double,2>::intersectWith(const ParaSurface<double,2> &S, struct InterPoint<double,2> &iter, int maxI, double um, double uM, double vm, double vM) const{cerr << "NOT DEFINED FOR 2D SURFACES.\n";}
